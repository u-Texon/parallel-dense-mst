...
\include{modules/0-Zusammenfassung}
...
\include{modules/1-Einführung}
\include{modules/2-Grundlagen}
\include{modules/3-Related-Work}
\include{modules/4-Algorithmen}
\include{modules/5-Implementierung}
\include{modules/6-Ergebnisse}
\include{modules/7-Fazit}
