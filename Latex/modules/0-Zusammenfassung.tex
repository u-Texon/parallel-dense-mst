...
Wir beschäftigen uns mit der Frage, wie MSTs auf Supercomputer mit mehreren tausend Prozessoren effizient berechnet werden können. Solche Supercomputer sind verteilte Systeme, in welchen die Prozessoren nicht über den geteilten Speicher (shared-memory), sondern mittels dedizierten
...
Auf diesen \enquote{dichten} Graphen hab wir vier verteilte MST Algorithmen \\(nach-)implementiert, weitere Verbesserungen für die Praxis vorgenommen und auf über zweitausend Prozessoren evaluiert.
